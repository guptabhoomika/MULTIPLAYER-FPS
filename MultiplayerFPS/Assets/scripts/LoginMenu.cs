...
public class LoginMenu : MonoBehaviour
{
    ...
    IEnumerator LoginUser()
    {
        ...
        if (response == "Success")
        {
            //Username and Password were correct. Stop showing 'Loading...' and show the LogIn UI. And set the text to display the username.
            ResetAllUIElements();
    ...
    IEnumerator RegisterUser()
    {
        ...
        if (response == "Success")
        {
            //Username and Password were valid. Account has been created. Stop showing 'Loading...' and show the LogIn UI and set text to display the username.
            ResetAllUIElements();
            loadingParent.gameObject.SetActive(false);
            useraccmanager.instance.LogIn(username, password);
    ...
    public void LogIn_LogoutButtonPressed()
    {
        loginParent.gameObject.SetActive(true);
        ResetAllUIElements();
